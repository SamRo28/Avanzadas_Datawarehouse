    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div class="bg-steam-card p-6 rounded-xl border border-gray-800 h-[400px] flex flex-col">
          ...
          <p class="text-gray-400 text-sm mb-4">Investigates the correlation between a game's price and its user quality score.</p>
        ...
        <div class="bg-steam-card p-6 rounded-xl border border-gray-800 xl:col-span-2 h-[400px] flex flex-col">
          ...
          <p class="text-gray-400 text-sm mb-4">Shows how active developer support (updates, interaction) influences average user ratings.</p>
